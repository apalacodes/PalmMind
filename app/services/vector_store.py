...
metatadata_collection = db["chunks_metadata"]
...
def store_vectors(chunks:list[str], vectors:list[list[float]],filename:str) -> int :
    ...
    if mongo_docs:
        metatadata_collection.insert_many(mongo_docs)
